...
const Homepage = () => {
  ...
  useEffect(() => {
    setVenues(mockData); // Simulate API fetch
  }, []);
  ...
  const paginatedAvailable = available.slice((currentPage - 1) * perPage, currentPage * perPage);

  return (
    <>
    <div className="bg-slate-50 min-h-screen p-6 space-y-10">
      <h1 className="text-2xl font-bold text-slate-800">Manage Keys And Access</h1>

      <SearchBar search={search} setSearch={setSearch} />

      <section>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Available Venues</h2>
      ...
      <section>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Recently Ordered Venues</h2>
        <div className="space-y-4">
